...
def create_data_list(data_root_path):
    ...
    with open(os.path.join(data_root_path, 'data/news_classify_data.txt'), 'r', encoding='utf-8') as f_data:
...
def train():
    ...
    # 获取数据字典长度
    dict_dim = get_dict_len('/home/zh/PycharmProjects/textclassify/dict_txt.txt')
    # 获取卷积神经网络
    ...
    # 获取训练数据读取器和测试数据读取器
    train_reader1 = paddle.batch(reader=train_reader("/home/zh/PycharmProjects/textclassify/train_list.txt"), batch_size=128)
    test_reader1 = paddle.batch(reader=test_reader("/home/zh/PycharmProjects/textclassify/test_list.txt"), batch_size=128)
    ...
    EPOCH_NUM=25
    model_save_dir = '/home/zh/PycharmProjects/textclassify/infer_model/'
    # 开始训练
    train_dir = "/home/zh/PycharmProjects/textclassify/train_list.txt"
    test_dir = "/home/zh/PycharmProjects/textclassify/test_list.txt"
    for pass_id in range(EPOCH_NUM):
        ...
        test_costs = []
        test_accs = []
        for batch_id, data in enumerate(test_reader1()):
...
def get_data(sentence):
    # 读取数据字典
    with open('/home/zh/PycharmProjects/textclassify/dict_txt.txt', 'r', encoding='utf-8') as f_data:
        dict_txt = eval(f_data.readlines()[0])
...
def model_train():
    ...
    data_root_path = "/home/zh/PycharmProjects/textclassify/"
    data_path = os.path.join(data_root_path, 'data/news_classify_data.txt')
...
if __name__ == '__main__':
    ...
    save_path = '/home/zh/PycharmProjects/textclassify/infer_model/'
